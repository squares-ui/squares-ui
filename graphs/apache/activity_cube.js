...
function graph_apache_activity_cube(id){
	...
	for (var i = 0; i < allIPs.length; i++){
		...
		vertex2.x = grid_size;
		vertex2.y = ((ipFirstHalf.indexOf(ipParts[0]+"."+ipParts[1]) / ipFirstHalf.length) * grid_size);
		vertex2.z = ((ipSecondHalf.indexOf(ipParts[2]+"."+ipParts[3]) / ipSecondHalf.length) * grid_size);
		...
		sphere.sakeName = ipParts[0]+"."+ipParts[1]+"."+ipParts[2]+"."+ipParts[3];
